...
TKW-x does not support the ITK 1.0 standard and any support issues for TKW should be raised with the ITK Accreditation team via the Solution Assurance helpdesk.
