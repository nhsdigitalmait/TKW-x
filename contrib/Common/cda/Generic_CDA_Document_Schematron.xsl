...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:Preceding contentId extension is not matching templateId, the value should be '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: ContentId '<xsl:text/>
               <xsl:value-of select="child::npfitlc:contentId/@extension"/>
               <xsl:text/>' is missing templateId.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:Template Reference class '<xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>' should contain a code element with nullFlavour attribute only.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: reference template '<xsl:text/>
               <xsl:value-of select="hl7v3:templateId/@extension"/>
               <xsl:text/>' id '<xsl:text/>
               <xsl:value-of select="hl7v3:id/@root"/>
               <xsl:text/>' is orphaned</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:message>
               ...
               <xsl:text/>' used is never referenced in the message. The reference template can be an disallowed one, please check the respective domain for the allowable list.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:ClinicalDocument messageType/@root value should be '2.16.840.1.113883.2.1.3.2.4.18.17' but is '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:contentId/@root value should be '2.16.840.1.113883.2.1.3.2.4.18.16' but is '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:content '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:originalText/reference '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:CREType list CRETypeList value/@root '<xsl:text/>
               <xsl:value-of select="@root"/>
               <xsl:text/>' is orphaned.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:CREType list value/@root '<xsl:text/>
               <xsl:value-of select="@root"/>
               <xsl:text/>' is duplicated.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:DIProcedureEvent list id/@root '<xsl:text/>
               <xsl:value-of select="@root"/>
               <xsl:text/>' is orphaned.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: Medication template '<xsl:text/>
               <xsl:value-of select="hl7v3:templateId/@extension"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:message>
               ...
               <xsl:text/>' id '<xsl:text/>
               <xsl:value-of select="hl7v3:id/@root"/>
               <xsl:text/>' is not in CRETypeList</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: Allergy template '<xsl:text/>
               <xsl:value-of select="hl7v3:templateId/@extension"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: CRETypeList template '<xsl:text/>
               <xsl:value-of select="hl7v3:templateId/@extension"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: ClinicalTemplate id is duplicated '<xsl:text/>
               <xsl:value-of select="@root"/>
               <xsl:text/>'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: value @xsi:type is wrong should be IVL_TS or ST or REAL or PQ or INT but is '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: value @xsi:type is wrong should be ST or REAL or PQ but is '<xsl:text/>
               <xsl:value-of select="@xsi:type"/>
               <xsl:text/>'.</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: SDS User ID and SDS User Role Profile ID OID's are in the wrong order should be '1.2.826.0.1285.0.2.0.65' and '1.2.826.0.1285.0.2.0.67' but in order '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: SDS User ID and SDS User Role Profile ID are identical '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: Count of id's for user and role profile are wrong should be 2 but is '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: SDS User ID and Unknown SDS User Role Profile should be '1.2.826.0.1285.0.2.0.65' and 'UNK' but in order '<xsl:text/>
               <xsl:value-of select="hl7v3:id[1]/@root"/>
               <xsl:text/>' and '<xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: Attribute '<xsl:text/>
               <xsl:value-of select="name(.)"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>'Error: no Case Reference (OID '2.16.840.1.113883.2.1.3.2.4.18.34') found in EncompassingEncounter id'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>'Error: AssignedAuthor code nullFlavor must be NI'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>'Error: AssignedAuthor id nullFlavor must be NI'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="@nullFlavor='NI'">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:Author id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error: Patient id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:AssignedEntity (PersonUniversal template) id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:WorkgroupUniversal Author id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:RecipientWorkgroupUniversal id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.2 4'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:IntendedRecipient id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:value-of select="string('&#xA;')"/>
            <xsl:message>
               <xsl:text>Schematron : </xsl:text>Error:Participant (DocumentParticipantUniversal) AssociatedEntity id must have assigningAuthorityName attribute for codeSystem'2.16.840.1.113883.2.1.3.2.4.18.24'</xsl:message>
            <svrl:failed-assert xmlns:xs="http://www.w3.org/2001/XMLSchema"
                                xmlns:svrl="http://www.ascc.net/xml/schematron"
                                test="attribute::assigningAuthorityName">
               <xsl:attribute name="location">XPath:N/A</xsl:attribute>
