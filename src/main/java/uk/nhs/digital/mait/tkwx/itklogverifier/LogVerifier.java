...
public class LogVerifier {
    ...
    private LogVerifier() {
        ...
        try {
            ...
            bootException = e;
            Logger.getInstance().log(SEVERE,LogVerifier.class.getName(),"Cannot load keystore: " + e.getMessage());
            return;
        }
        try {
            ...
            bootException = e;
            Logger.getInstance().log(SEVERE,LogVerifier.class.getName(),"Cannot read keystore: " + e.getMessage());
        }
    }
    ...
    private String makePass(String[] src, String t) {
        ...
        try {
            ...
            bootException = e;
            Logger.getInstance().log(SEVERE,LogVerifier.class.getName(),"Cannot make internal " + t +  "password: " + e.toString());
        }
        return null;
    }
