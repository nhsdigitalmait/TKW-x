 ...
 * then business ack is also sent (+ve or negative - configuarble)
 *
 * @author Richard Robinson rrobinson@hscic.gov.uk
 */
public class ITKTrunkDistributionEnvelopeHandler extends AbstractDistEnvelopeHandler
     ...
     */
    public ITKTrunkDistributionEnvelopeHandler()
    ...
    public void handle(DistributionEnvelope d)
        ...
        if (infackReq != null && infackReq.toLowerCase().equals("true")) {
            ...
            ITKTrunkDistributionEnvelopeHandler.sleep(3000);
        }
