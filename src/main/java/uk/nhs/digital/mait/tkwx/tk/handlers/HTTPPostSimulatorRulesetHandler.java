...
import uk.nhs.digital.mait.tkwx.http.HttpResponse;
 ...
 /**
 * Handler implementation for HTTP POST requests for dynamically reconfiguring the simulator ruleset. TKW wants a single
 ...
 */
public class HTTPPostSimulatorRulesetHandler 
    extends uk.nhs.digital.mait.tkwx.tk.boot.ToolkitHttpHandler
{
    ...
    {
        HTTPPostSimulatorRulesetWorker s = new HTTPPostSimulatorRulesetWorker(this);
