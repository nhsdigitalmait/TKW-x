 ...
 * followed by asynchronous Bus Ack only. This Routing actor uses MESH
 * transport for sending its response
 *
 * @author Richard Robinson rrobinson@nhs.net
 */
public class MESHFHIRITKRoutingActorBusAckOnly
     ...
     * @throws Exception
     */
    public MESHFHIRITKRoutingActorBusAckOnly()
            throws Exception {
        super();
        init();
    }
