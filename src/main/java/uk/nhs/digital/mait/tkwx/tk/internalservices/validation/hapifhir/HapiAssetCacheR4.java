 ...
 */
public class HapiAssetCacheR4 implements HapiAssetCacheInterface {
...
//    private static final int SEARCHPARAMETER_TYPE = 8;
    ...
    public HapiAssetCacheR4(ArrayList<File> ignoreList) {
        super();
        context = FhirContext.forR4();
        this.ignoreList = ignoreList;
    }

    public HapiAssetCacheR4(FhirContext c, ArrayList<File> ignoreList) {
        super();
        context = c;
        this.ignoreList = ignoreList;
    }
