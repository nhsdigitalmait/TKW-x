 ...
 */
public class HapiAssetCacheR5 implements HapiAssetCacheInterface {
...
//    private static final int SEARCHPARAMETER_TYPE = 8;
    ...
    public HapiAssetCacheR5(ArrayList<File> ignoreList) {
        super();
        context = FhirContext.forR5();
        this.ignoreList = ignoreList;
    }

    public HapiAssetCacheR5(FhirContext c, ArrayList<File> ignoreList) {
        super();
        context = c;
        this.ignoreList = ignoreList;
    }
