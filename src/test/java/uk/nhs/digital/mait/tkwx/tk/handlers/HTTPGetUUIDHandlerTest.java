 ...
 * @author sifa2
 */
public class HTTPGetUUIDHandlerTest extends AbstractHandler {

    private HttpRequest req;
    private HttpResponse resp;

    public HTTPGetUUIDHandlerTest() {
    }
    ...
    /**
     * Test of handle method, of class HTTPGetUUIDHandler.
     *
    ...
    public void testHandle() throws Exception {
        ...
        HTTPGetUUIDHandler instance = new HTTPGetUUIDHandler();
