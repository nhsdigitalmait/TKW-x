 ...
 * @author sifa2
 */
public class HTTPGetUUIDWorkerTest extends AbstractHandler {

    private HttpRequest req;
    private HttpResponse resp;
    private HTTPGetUUIDWorker instance;

    public HTTPGetUUIDWorkerTest() {
    }
    ...
    public void setUp() throws Exception {
        ...
        HTTPGetUUIDHandler hguh = new HTTPGetUUIDHandler();
        hguh.setSavedMessagesDirectory(TEMPFOLDER);
        instance = new HTTPGetUUIDWorker(hguh);
    }
    ...
    /**
     * Test of handle method, of class HTTPGetUUIDWorker.
    ...
    public void testHandle() throws Exception {
        ...
        String expResult = "^<uuid>[0-9A-Z-]+</uuid>$";
