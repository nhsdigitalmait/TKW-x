 ...
 * @author simonfarrow
 */
public class HTTPPutResetSimulatorStateVariablesWorkerTest extends AbstractHandler {

    private HttpRequest req;
    private HttpResponse resp;
    private HTTPPutResetSimulatorStateVariablesWorker instance;
    ...
    public HTTPPutResetSimulatorStateVariablesWorkerTest() {
    }
    ...
    public void setUp() throws Exception {
        ...
        HTTPPutResetSimulatorStateVariablesHandler hpsrh = new HTTPPutResetSimulatorStateVariablesHandler();
        instance = new HTTPPutResetSimulatorStateVariablesWorker(hpsrh);
    }
     ...
     * HTTPPutResetSimulatorStateVariablesWorker.
     *
