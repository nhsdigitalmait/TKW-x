...
public class SpineSynchronousWorkerTest extends AbstractHandler {
    ...
    public void testHandle() throws Exception {
        ...
        assertEquals(2, simulatorSavedMessages.listFiles().length);
        deleteLatestFiles(2);
    }
    ...
    public void testSynchronousResponse() throws Exception {
        ...
        instance.synchronousResponse(httpError, statusText, soapBody, req, resp, soapAction);
        ...
        assertTrue(result.contains(soapAction));
        assertTrue(result.contains(soapBody));
    }
    ...
    /**
     * Test of setValidationReport method, of class SpineSynchronousWorker.
     */
    @Test
