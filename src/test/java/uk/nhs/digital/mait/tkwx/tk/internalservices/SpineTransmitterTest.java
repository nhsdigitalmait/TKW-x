...
/**
 * Suspect that the class under test deprecated
 *
 * @author sifa2
 */
public class SpineTransmitterTest {

    private SpineTransmitter instance;

    public SpineTransmitterTest() {
    }
    ...
    /**
     * Test of getBootProperties method, of class SpineTransmitter.
     */
    @Test
    ...
    /**
     * Test of boot method, of class SpineTransmitter.
     *
    ...
    /**
     * Test of execute method, of class SpineTransmitter.
     *
     * @throws java.lang.Exception
     */
    @Test
    public void testExecute_Object() throws Exception {
        ...
        // this is the one that does the work - fails with unexpected sub folders - cache etc
        // suspect the class under test is deprecated in favour of a SpineTools equivalent

        // this param is ignored
        Object param = null;
        ServiceResponse expResult = null;
        // TODO for now this is a disabled test
