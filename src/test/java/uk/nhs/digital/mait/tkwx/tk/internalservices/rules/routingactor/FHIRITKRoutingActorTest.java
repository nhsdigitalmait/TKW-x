...
public class FHIRITKRoutingActorTest {
    ...
    public FHIRITKRoutingActorTest() {
    }
    ...
    public void setUp() throws Exception {
        ...
        p.setProperty("tks.routingactor.fhir.ba.errorcode", "7777");
        p.setProperty("tks.routingactor.fhir.ba.responsecode", "responsecode");
        p.setProperty("tks.routingactor.fhir.ba.errortext", "ba errortext");
        p.setProperty("tks.routingactor.fhir.ba.issueseverity", "ba issueseverity");
        p.setProperty("tks.routingactor.fhir.ba.issuetext", "ba issuetext");

        // per error code values if set error code is called
        ...
        p.setProperty("tks.routingactor.fhir.ba.errorcode.9999", "8888");
        p.setProperty("tks.routingactor.fhir.ba.responsecode.9999", "responsecode");
        p.setProperty("tks.routingactor.fhir.ba.errortext.9999", "ba errortext");
        p.setProperty("tks.routingactor.fhir.ba.issueseverity.9999", "ba issueseverity");
        p.setProperty("tks.routingactor.fhir.ba.issuetext.9999", "ba issuetext");
        ...
        c.setProperties(p);
        instance = new FHIRITKRoutingActor();
        instance.setErrorCode("9999");
    }
    ...
    /**
     * Test of init method, of class FHIRITKRoutingActor.
     *
    ...
    /**
     * Test of makeResponse method, of class FHIRITKRoutingActor.
     *
     * @throws java.lang.Exception
     */
    @Test
    ...
    /**
     * Test of forceClose method, of class FHIRITKRoutingActor.
     */
    @Test
