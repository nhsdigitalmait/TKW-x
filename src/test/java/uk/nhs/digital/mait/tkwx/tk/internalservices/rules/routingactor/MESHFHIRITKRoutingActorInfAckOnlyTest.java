...
public class MESHFHIRITKRoutingActorInfAckOnlyTest {
    ...
    /**
     * Test of makeResponse method, of class MESHFHIRITKRoutingActorInfAckOnly.
    ...
    public void testMakeResponse() throws Exception {
        ...
        MESHFHIRITKRoutingActorInfAckOnly instance = new MESHFHIRITKRoutingActorInfAckOnly();
        String expResult = "";
        String result = instance.makeResponse(substitutions, mr);
        assertEquals(expResult, result);
 
        // 1 pair of dat and ctl for inf
