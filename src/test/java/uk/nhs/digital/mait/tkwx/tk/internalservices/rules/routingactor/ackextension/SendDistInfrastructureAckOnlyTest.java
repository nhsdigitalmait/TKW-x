 ...
 * @author simonfarrow
 */
public class SendDistInfrastructureAckOnlyTest {

    @Rule
    public final RestoreSystemProperties restoreSystemProperties
            = new RestoreSystemProperties();

    public SendDistInfrastructureAckOnlyTest() {
    }
    ...
    /**
     * Test of makeResponse method, of class SendDistInfrastructureAckOnly.
     *
    ...
    public void testMakeResponse() throws Exception {
        ...
        SendDistInfrastructureAckOnly instance = new SendDistInfrastructureAckOnly();
        String expResult = "";
