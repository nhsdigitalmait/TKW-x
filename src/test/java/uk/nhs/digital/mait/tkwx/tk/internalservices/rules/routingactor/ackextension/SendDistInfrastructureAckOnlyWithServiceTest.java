 ...
 * @author simonfarrow
 */
public class SendDistInfrastructureAckOnlyWithServiceTest {

    @Rule
    public final RestoreSystemProperties restoreSystemProperties
            = new RestoreSystemProperties();

    public SendDistInfrastructureAckOnlyWithServiceTest() {
    }
     ...
     * SendDistInfrastructureAckOnlyWithService.
     */
    @Test
    public void testMakeResponse() throws Exception {
        ...
        SendDistInfrastructureAckOnlyWithService instance = new SendDistInfrastructureAckOnlyWithService();
        String expResult = "";
