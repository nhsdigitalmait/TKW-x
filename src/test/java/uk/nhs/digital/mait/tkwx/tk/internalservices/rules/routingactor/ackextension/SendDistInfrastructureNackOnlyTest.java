 ...
 * @author simonfarrow
 */
public class SendDistInfrastructureNackOnlyTest {

    @Rule
    public final RestoreSystemProperties restoreSystemProperties
            = new RestoreSystemProperties();

    public SendDistInfrastructureNackOnlyTest() {
    }
    ...
    /**
     * Test of makeResponse method, of class SendDistInfrastructureNackOnly.
     */
    @Test
    public void testMakeResponse() throws Exception {
        ...
        SendDistInfrastructureNackOnly instance = new SendDistInfrastructureNackOnly();
        String expResult = "";
