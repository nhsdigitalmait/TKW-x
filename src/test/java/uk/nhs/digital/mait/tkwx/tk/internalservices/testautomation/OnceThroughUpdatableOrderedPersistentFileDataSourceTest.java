 ...
 * @author sifa2
 */
public class OnceThroughUpdatableOrderedPersistentFileDataSourceTest {
    private static AutotestParser.DatasourceContext datasourceCtx;
    private OnceThroughUpdatableOrderedPersistentFileDataSource instance;

    public OnceThroughUpdatableOrderedPersistentFileDataSourceTest() {
    }
    ...
    @Before
    public void setUp() {
        instance = new OnceThroughUpdatableOrderedPersistentFileDataSource();
    }
     ...
     * OnceThroughUpdatableOrderedPersistentFileDataSource.
     */
    @Test
