 ...
 * @author sifa2
 */
public class AndPassFailCheckTest {
    private static AutotestParser.PassfailContext passfailCtx;

    public AndPassFailCheckTest() {
    }
    ...
    /**
     * Test of processSubTests method, of class AndPassFailCheck.
     *
    ...
    public void testProcessSubTests() throws Exception {
        ...
        AndPassFailCheck instance = new AndPassFailCheck();
