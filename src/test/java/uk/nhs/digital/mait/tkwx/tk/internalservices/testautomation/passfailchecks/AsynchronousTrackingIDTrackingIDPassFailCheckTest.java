 ...
 * @author sifa2
 */
public class AsynchronousTrackingIDTrackingIDPassFailCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;

    public AsynchronousTrackingIDTrackingIDPassFailCheckTest() {
    }
     ...
     * AsynchronousTrackingIDTrackingIDPassFailCheck.
     *
    ...
    public void testInit() throws Exception {
        ...
        String[] line = {"", ""};
        AsynchronousTrackingIDTrackingIDPassFailCheck instance = new AsynchronousTrackingIDTrackingIDPassFailCheck();
