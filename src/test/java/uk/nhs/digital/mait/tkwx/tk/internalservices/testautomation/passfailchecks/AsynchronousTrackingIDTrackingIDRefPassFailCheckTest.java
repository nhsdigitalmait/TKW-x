 ...
 * @author sifa2
 */
public class AsynchronousTrackingIDTrackingIDRefPassFailCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;

    public AsynchronousTrackingIDTrackingIDRefPassFailCheckTest() {
    }
     ...
     * AsynchronousTrackingIDTrackingIDRefPassFailCheck.
     *
    ...
    public void testInit() throws Exception {
        ...
        String[] line = {"", ""};
        AsynchronousTrackingIDTrackingIDRefPassFailCheck instance = new AsynchronousTrackingIDTrackingIDRefPassFailCheck();
