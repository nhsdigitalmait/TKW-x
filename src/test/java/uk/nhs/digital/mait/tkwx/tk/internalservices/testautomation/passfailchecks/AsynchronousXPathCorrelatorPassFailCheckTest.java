 ...
 * @author simonfarrow
 */
public class AsynchronousXPathCorrelatorPassFailCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private AsynchronousXPathCorrelatorPassFailCheck instance;

    public AsynchronousXPathCorrelatorPassFailCheckTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("asynchronousxpathcorrelation")) {
    ...
    @Before
    public void setUp() {
        instance = new AsynchronousXPathCorrelatorPassFailCheck();
    }
    ...
    /**
     * Test of init method, of class AsynchronousXPathCorrelatorPassFailCheck.
     */
    @Test
     ...
     * AsynchronousXPathCorrelatorPassFailCheck.
     */
    @Test
