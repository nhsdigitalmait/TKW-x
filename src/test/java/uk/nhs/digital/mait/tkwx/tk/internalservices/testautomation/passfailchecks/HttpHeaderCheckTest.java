 ...
 * @author simonfarrow
 */
public class HttpHeaderCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private HttpHeaderCheck instance;

    public HttpHeaderCheckTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("httpheaderchecknonzerocontent")) {
    ...
    /**
     * Test of init method, of class HttpHeaderCheck.
     *
    ...
    /**
     * Test of passed method, of class HttpHeaderCheck.
     *
     * @throws java.lang.Exception
     */
    @Test
