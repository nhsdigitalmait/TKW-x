 ...
 * @author simonfarrow
 */
public class HttpHeaderCorrelationCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private HttpHeaderCorrelationCheck instance;

    public HttpHeaderCorrelationCheckTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("httpheadercorrelation")) {
    ...
    @Before
    public void setUp() {
        instance = new HttpHeaderCorrelationCheck();
    }
    ...
    /**
     * Test of init method, of class HttpHeaderCorrelationCheck.
    ...
    /**
     * Test of passed method, of class HttpHeaderCorrelationCheck.
     * @throws java.lang.Exception
     */
    @Test
    public void testPassed() throws Exception {
        ...
        instance.init(passfailCtx);
        Script s = null;
        InputStream inSync = new ByteArrayInputStream(("Header1: value1\r\n\r\n"+END_REQUEST_MARKER+"\r\nHTTP/1.1 202\r\nHeader2: value1\r\n\r\n").getBytes());
        InputStream inAsync = null;
        TestResult expResult = PASS;
        TestResult result = instance.passed(s, inSync, inAsync);

        assertEquals(expResult, result);

        inSync = new ByteArrayInputStream(("Header1: value1\r\n\r\n"+END_REQUEST_MARKER+"\r\nHTTP/1.1 202\r\nHeader2: value2\r\n\r\n").getBytes());
        expResult = FAIL;
        result = instance.passed(s, inSync, inAsync);
        assertEquals(expResult, result);
    }
