 ...
 * @author simonfarrow
 */
public class HttpStatusCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private HttpStatusCheck instance;

    public HttpStatusCheckTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("httpstatuscheck206")) {
    ...
    /**
     * Test of init method, of class HttpStatusCheck.
     *
    ...
    /**
     * Test of passed method, of class HttpStatusCheck.
     *
     * @throws java.lang.Exception
     */
    @Test
