...
public class NullRequestTest {
    ...
    private NullRequest instance;

    public NullRequestTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("nullrq")) {
    ...
    /**
     * Test of init method, of class NullRequest.
     *
    ...
    /**
     * Test of passed method, of class NullRequest.
     *
     * @throws java.lang.Exception
     */
    @Test
    public void testPassed() throws Exception {
        ...
        instance.init(passfailCheckCtx);
        Script s = null;
        InputStream in = new ByteArrayInputStream(("Failed"+END_INBOUND_MARKER+"\r\nHTTP/1.1 206\r\nContent-Length: 1\r\n\r\n").getBytes());
        InputStream inRequest = null;
        TestResult expResult = PASS;
        TestResult result = instance.passed(s, in, inRequest);
        assertEquals(expResult, result);

        in = new ByteArrayInputStream((END_INBOUND_MARKER+"\r\nHTTP/1.1 202\r\nContent-Length: 0\r\n\r\n").getBytes());
        expResult = FAIL;
