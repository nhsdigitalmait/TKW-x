 ...
 * @author simonfarrow
 */
public class SecondAsynchronousXPathCorrelatorPassFailCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private SecondAsynchronousXPathCorrelatorPassFailCheck instance;

    public SecondAsynchronousXPathCorrelatorPassFailCheckTest() {
    }
    ...
    public static void setUpClass() throws IOException {
        ...
        for (AutotestParser.PassfailContext lpassfailCtx : passfailsCtx.passfail()) {
            if (lpassfailCtx.passFailCheckName().getText().equals("secondasynchronousxpathcorrelation")) {
    ...
    @Before
    public void setUp() {
        instance = new SecondAsynchronousXPathCorrelatorPassFailCheck();
    }
     ...
     * SecondAsynchronousXPathCorrelatorPassFailCheck.
     */
    @Test
