 ...
 * @author simonfarrow
 */
public class XPathCorrelatorPassFailCheckTest {

    private static AutotestParser.PassfailContext passfailCtx;
    private XPathCorrelatorPassFailCheck instance;

    public XPathCorrelatorPassFailCheckTest() {
    }
    ...
    public void setUp() throws Exception {
        instance = new XPathCorrelatorPassFailCheck(new SynchronousXPathCorrelatorPassFailCheck());
    }
    ...
    /**
     * Test of init method, of class XPathCorrelatorPassFailCheck.
     */
    @Test
    public void testInit() throws Exception {
        System.out.println("init");
        instance.init(passfailCtx.passFailCheck());
    }

    /**
     * Test of doChecks method, of class XPathCorrelatorPassFailCheck.
     */
    @Test
