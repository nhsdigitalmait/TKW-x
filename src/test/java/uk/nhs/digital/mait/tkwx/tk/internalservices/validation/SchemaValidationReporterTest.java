 ...
 * @author sifa2
 */
public class SchemaValidationReporterTest {
    
    public SchemaValidationReporterTest() {
    }
    ...
    /**
     * Test of addValidationExceptionDetail method, of class SchemaValidationReporter.
     */
    @Test
    public void testAddValidationExceptionDetail() {
        System.out.println("addValidationExceptionDetail");
        String s = "";
        SchemaValidationReporter instance = new SchemaValidationReporterImpl();
