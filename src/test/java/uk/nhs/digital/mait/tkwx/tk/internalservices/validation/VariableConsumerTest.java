 ...
 * @author sifa2
 */
public class VariableConsumerTest {

    public VariableConsumerTest() {
    }
    ...
    /**
     * Test of setVariableProvider method, of class VariableConsumer.
     */
    @Test
    public void testSetVariableProvider() {
        System.out.println("setVariableProvider");
        VariableProvider vp = null;
        VariableConsumer instance = new VariableConsumerImpl();
        instance.setVariableProvider(vp);
    }

    public class VariableConsumerImpl implements VariableConsumer {
